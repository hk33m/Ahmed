              ...
              <AnimatePresence>
                {stage === "opening" && (
                  <motion.div
                    ...
                    className="pointer-events-none absolute bottom-10 left-0 right-0 z-20 flex justify-center text-center"
                  >
                    <div>
                      ...
                      <p className="mt-2 text-xs tracking-[0.25em] text-white/80">
                        اضغط على الظرف
                      </p>
